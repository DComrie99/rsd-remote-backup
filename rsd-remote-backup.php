...
function RSD_RB_init(): void {
    ...
    require_once RSD_RB_DIR . 'includes/class-update-installer.php';
    ...
    require_once RSD_RB_DIR . 'includes/class-file-deleter.php';
    ...
    if ( is_admin() ) {
        ...
        require_once RSD_RB_DIR . 'admin/class-maintenance-page.php';
    }
